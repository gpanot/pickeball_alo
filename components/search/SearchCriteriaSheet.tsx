    ...
    <>
      ...
      >
        ...
        <div style={{ padding: '0 20px 8px', borderBottom: `1px solid ${t.border}` }}>
          <h2 style={{ margin: 0, fontSize: 17, fontWeight: 800, color: t.text }}>Edit search</h2>
          <p style={{ margin: '6px 0 0', fontSize: 13, color: t.textSec }}>Update filters and search again</p>
        </div>
        ...
        >
          ...
          >
            <SearchIcon size={18} />
            {applying ? 'SEARCHING…' : 'UPDATE SEARCH'}
          </button>
        </div>
      </div>
    </>
